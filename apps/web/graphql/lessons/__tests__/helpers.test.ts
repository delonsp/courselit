/**
 * Tests for lessonsOrder sort safety in GraphQL lesson helpers.
 * US-003: Handle undefined lessonsOrder and missing lessonId (backend).
 */

describe("GraphQL lessonsOrder sort safety", () => {
    const sortLessons = (
